...
export const propertiesTable = pgTable("properties", {
  ...
  livingRoomArea: real("living_room_area"),
  garageArea: real("garage_area"),
  ...
  indoorParking: integer("indoor_parking"),
  outdoorParking: integer("outdoor_parking"),
  // Energy
  dpeRating: text("dpe_rating"),
  gesRating: text("ges_rating"),
  energyConsumption: real("energy_consumption"),
  gesEmissions: real("ges_emissions"),
