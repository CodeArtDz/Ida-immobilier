...
export const CreatePropertyBody = zod.object({
  ...
  "livingRoomArea": zod.number().optional(),
  "garageArea": zod.number().optional(),
  "gardenArea": zod.number().optional(),
  "terraceArea": zod.number().optional(),
  "showerRooms": zod.number().optional(),
  "levels": zod.number().optional(),
  "kitchen": zod.string().optional(),
  "water": zod.string().optional(),
  "sanitation": zod.string().optional(),
  "indoorParking": zod.number().optional(),
  "outdoorParking": zod.number().optional(),
  "energyConsumption": zod.number().optional(),
  "gesEmissions": zod.number().optional(),
  "hasDisabledAccess": zod.boolean().optional()
})
...
export const ListArticlesResponse = zod.object({
  ...
  "coverImageWebpUrl": zod.string().nullish(),
  "coverImageAvifUrl": zod.string().nullish(),
  "coverImageWidth": zod.number().nullish(),
  "coverImageHeight": zod.number().nullish(),
